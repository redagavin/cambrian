...
python cambrian/train/train_tpu.py \
    ...
    --vision_tower_aux_list '["openai/clip-vit-large-patch14-336", "facebook/dinov2-giant-res378"]' \
...
gcloud alpha storage rsync $CKPT_PATH gs://us-central2-storage/cambrian/gavinyang/$CKPT_NAME
echo "Syncing finished. Checkpoints are now available at gs://us-central2-storage/cambrian/gavinyang/$CKPT_NAME"
