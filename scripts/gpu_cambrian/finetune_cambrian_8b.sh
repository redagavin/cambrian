...
#SBATCH -e cambrian_finetune.err                  # Name of stderr output log file (%j expands to jobID)
#SBATCH --nodes=1                                 # Total number of nodes requested
#SBATCH --ntasks-per-node=8                       # Total number of task requested
#SBATCH --cpus-per-task=12                        # Total number of cores requested
#SBATCH --mem=512G
...
export CKPT_NAME="cambrian-phi3-finetune"
...
deepspeed cambrian/train/train_gpu.py \
    ...
    --version phi3 \
    --data_path "/gpfs/data/oermannlab/users/yangz09/mllm/Cambrian-10M/jsons/Cambrian737k.jsonl" \
    --image_folder "/gpfs/data/oermannlab/users/yangz09/mllm/Cambrian-10M" \
    --pretrain_mm_mlp_adapter "/gpfs/data/oermannlab/users/yangz09/mllm/cambrian/checkpoints/cambrian-phi3-pretrain/mm_projector.bin" \
