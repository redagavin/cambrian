...
#SBATCH -e cambrian_pretrain.err                  # Name of stderr output log file (%j expands to jobID)
...
export CKPT_NAME="cambrian-phi3-pretrain"
...
deepspeed cambrian/train/train_gpu.py \
    ...
    --version phi3 \
    --data_path "/gpfs/data/oermannlab/users/yangz09/mllm/LLaVA/playground/data/LLaVA-Pretrain/blip_laion_cc_sbu_558k.json" \
    --image_folder "/gpfs/data/oermannlab/users/yangz09/mllm/LLaVA/playground/data/LLaVA-Pretrain/images" \
